  ...
  public = list(
    ...
    accionistasTabulado = function(){
      tabla = tibble(investor_name = sapply(private$.accionistas, function(a) a$entidad$name),
                     ...
                     empresa_principal_industry_reclassified = rep(private$.industry_reclassified, length(private$.accionistas)),
                     empresa_principal_industry_reclassified_2 = rep(private$.industry_reclassified_2, length(private$.accionistas)),
    ...
    filialesTabulado = function(){
      tabla = tibble(empresa_principal = rep(private$.name, length(private$.filiales)),
                     ...
                     industry_reclassified = sapply(private$.filiales, function(f) f$empresa$industry_reclassified),
                     industry_reclassified_2 = sapply(private$.filiales, function(f) f$empresa$industry_reclassified_2),
